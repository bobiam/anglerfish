...
// modified to work as a single pixel for an anglerfish stroller art piece for Flipside 2016 by Bob Eells.
...
SimplePatternList gPatterns = { blueGreen, white, red, green, blue, fadeUpDown, redFadeUpDown, greenFadeUpDown, blueFadeUpDown, popUpFadeDown, rainbow, rainbowWithGlitter, sinelon,  bpm };
